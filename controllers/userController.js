		...
		if (req.body.email && req.body.email != req.user.email) {
			if (process.env.EMAIL_HOST && process.env.EMAIL_PORT && process.env.EMAIL_USER && process.env.EMAIL_PASS) {
				if (req.user.lang == 'fr') {
					...
					var subject = `Verify your new email address on Squakr, @${req.user.username}.`
...
exports.registerUser = async (req, res, next) => {
	try {
		...
		if (process.env.EMAIL_HOST && process.env.EMAIL_PORT && process.env.EMAIL_USER && process.env.EMAIL_PASS) {
			if (req.body.lang == 'fr') {
				var subject = `Bienvenue sur Squakr, ${req.body.username} !`
				...
				var subject = `Welcome to Squakr, ${req.body.username} !`
